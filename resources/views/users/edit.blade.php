            ...
            <div class="col-12">
                <form method="POST" action="{{ route('user.update', $user->id) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input value="{{$user->dni}}" id="dni" type="text" class="form-control @error('dni') is-invalid @enderror" name="dni" value="{{ old('dni') }}" required autocomplete="dni">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input value="{{$user->university_id}}" id="university_id" type="text" class="form-control @error('university_id') is-invalid @enderror" name="university_id" value="{{ old('university_id') }}" autocomplete="university_id">
